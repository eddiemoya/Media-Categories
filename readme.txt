...
= Updates =
* Since version 1.6 : Supports WordPress 3.8.x * Reintroduces the category filter on metaboxes * Adds drowndown filters and sortable columns in the Media Library * Adds dropdown filters to the Media Modal/Media Manager * Gallery Shortcode now accepts multiple terms.
...
* New Feature - Filter media in the Media Modal/Media Manager by term with new dropdropdown menu.
